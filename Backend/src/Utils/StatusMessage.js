export default class StatusMessage {
    ...
    static ERROR_PARSING_COOKIES = 'Unable to read session cookies. Please ensure cookies are enabled in your browser and try again.'
    static ERROR_REFRESHING_ACCESS_TOKEN = 'There was a problem refreshing your authentication token.'
}
