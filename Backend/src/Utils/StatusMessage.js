export default class StatusMessage {
    ...
    static COULD_NOT_GET_USER_STATUS = 'Could not get user status from database.'
    static USER_STATUS_NOT_FOUND = 'User status not found.'
    static ERROR_SAVING_NOTIFICATION_TO_DB = 'There was an error creating notification in the database.'
}
