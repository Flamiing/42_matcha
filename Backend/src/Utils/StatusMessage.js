export default class StatusMessage {
    ...
    static ERROR_VALIDATING_PASSWORD = 'There was a problem validating your password. Please try again later.'
    static COMMON_ENGLISH_WORDS_FOUND = 'Password cannot contain commonly used english words.';
    static PWNED_PASSWORD = 'Your password is known to be compromised in security breaches. Please create a different, more secure password.'
}
